    ...
    <div class="col-xs-12 col-md-12">
        <div class="calendar-form">
            ...
            <div class="row <?php echo ($post_type == 'st_tours') ? 'tour-calendar-price-person' : ''; ?>">
                ...
                <div class="col-xs-4 ?>">
                    <div class="form-group ">
                        <label for="calendar_infant_price"><?php echo __('Help', 'traveler'); ?></label>
                        <a href="https://www.youtube.com/watch?v=_1mjCsdnpY4" target="_blank"><?php echo __('Open Help Video', 'traveler'); ?></a>
                    </div>
                </div>
