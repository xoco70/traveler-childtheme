    ...
    class ST_List_Service_Element extends \Elementor\Widget_Base
    {
        ...
        protected function register_controls()
        {
            ...
            $this->add_control(
                'style',
                [
                    'label' => esc_html__('Style (Grid Tour Single - Choose Style 1)', 'traveler'),
                    'type' => 'select',
                    'label_block' => true,
            ...
            $this->add_control(
                ...
                [
                    ...
                    'description' => esc_html__('Choose custom activities', 'traveler'),
                    'type' => \Elementor\Controls_Manager::SELECT2,
                    'multiple' => true,
                    'options' => st_child_get_activity_list(),
                    'condition' => [
                        'type_form' => 'single',
                        'service' => 'st_activity'
                    ]
