            ...
            <div class="sidebar-content">
                <div class="sidebar-header">
                    ...
                    if (!empty($logo)) {
                        ...
                        <a href="<?php echo site_url() ?>"><img src="<?php echo esc_attr($logo); ?>"
                                                                class="st-logo-site" alt="Logo"/></a>

                        <?php
                    } else { ?>
                        <a href="" title=""><img
                                    src="<?php echo get_template_directory_uri() . "/v2/images/dashboard/traveler_dashboard_logo.svg"; ?>"
                                    alt="" class="st-logo-site"></a>
                    <?php }
                    ?>
                    ...
                    <?php } else {
                        ...
                        <div class="sidebar-header">
                            ...
                            if (is_array($list_packages) && count($list_packages) > 1 && $enable) {
                                ?>
                                <div class="user-upgrade">
                                    <a href="<?php echo esc_url($admin_packages->register_member_page()); ?>"
                                       title=""><?php _e('Upgrade', 'traveler'); ?></a>
                                </div>
                            <?php } ?>
                        </div>
                        <?php
                        ...
                        <?php if (STUser_f::check_lever_partner($lever) and st()->get_option('partner_enable_feature') == 'on'): ?>
                            <li class="sidebar-dropdown <?php if ($sc == 'dashboard' or $sc == 'dashboard-info') echo 'active' ?>">
                                <a href="<?php echo TravelHelper::get_user_dashboared_link($user_link, 'dashboard'); ?>">
                                    <img src="<?php echo get_template_directory_uri() . "/v2/images/dashboard/ico_dashboard.svg"; ?>"
                                    ...
                                    <ul>
                                        <?php if (STUser_f::_check_service_available_partner('st_hotel')): ?>
                                            <li class="<?php if ($sc == 'dashboard-info' and STInput::request('type') == 'st_hotel') echo 'active' ?>">
                                                <a href="<?php echo add_query_arg('type', 'st_hotel', TravelHelper::get_user_dashboared_link($user_link, 'dashboard-info')); ?>"><?php _e('Hotel Statistics', 'traveler'); ?>
                                                    <span class="badge fa fa-angle-down badge-success"></span></a>
                                            </li>
                                        <?php endif; ?>
<!--                                        --><?php //if (STUser_f::_check_service_available_partner('st_hotel')): ?>
...
<!--                                        --><?php //endif; ?>
                        ...
                        <li class="<?php if ($sc == 'setting') echo 'active' ?>">
                            <a href="<?php echo esc_url(TravelHelper::get_user_dashboared_link($user_link, 'setting')) ?>">
                                <img src="<?php echo get_template_directory_uri() . "/v2/images/dashboard/ico_seting.svg"; ?>"
                                     alt="" class="st-icon-menu">
                        ...
                        ?>
                        <?php if (!STUser_f::check_lever_partner($lever)): ?>
                            <!--If type is User, display bookings-->
                            <?php if ($custom_layout_booking_history == "on") { ?>
                                <li class="<?php if ($sc == 'booking-history') echo 'active' ?>">
                                    <a href="<?php echo TravelHelper::get_user_dashboared_link($user_link, 'booking-history'); ?>">
                                        <img src="<?php echo get_template_directory_uri() . "/v2/images/dashboard/ico_booking_his.svg"; ?>"
                                             alt="" class="st-icon-menu">
                                        <span><?php _e("Booking History", 'traveler') ?></span>
                                    </a>
                                </li>
                            <?php } ?>
                        <?php else: ?><!-- else if partner, display booking history-->
                            <li <?php if ($sc == 'booking-activity')
                                echo 'class="active"' ?>>
                                <a href="<?php echo TravelHelper::get_user_dashboared_link($user_link, 'booking-activity'); ?>">
                                    <img src="<?php echo get_template_directory_uri() . "/v2/images/dashboard/ico_booking_his.svg"; ?>"
                                         alt="" class="st-icon-menu"><?php _e("Booking History", 'traveler') ?>
                                </a>
                            </li>
                        <?php endif ?>
...
<!--                            --><?php //if (STUser_f::_check_service_available_partner('st_hotel')): ?>
<!--                                <li class="sidebar-dropdown st-active --><?php //if (in_array($sc, array('my-hotel', 'create-hotel', 'edit-hotel', 'add-hotel-booking', 'booking-hotel', 'hotel-inventory', 'my-room', 'edit-room', 'create-room', 'add-hotel-room-booking', 'booking-hotel-room'))) {
//                                    echo 'active';
//                                } ?><!--">-->
<!--                                    <a href="#">-->
<!--                                        <img src="--><?php //echo get_template_directory_uri() . "/v2/images/dashboard/ico_hotel.svg"; ?><!--"-->
<!--                                             alt="" class="st-icon-menu">-->
...
//                                                echo 'class="active"' ?><!-->-->
<!--                                                <a href="--><?php //echo TravelHelper::get_user_dashboared_link($user_link, 'my-hotel'); ?><!--">--><?php //_e("My Hotel", 'traveler') ?>
<!--                                                    <span class="badge fa fa-angle-down badge-success"></span></a>-->
<!--                                            </li>-->
...
//                                                echo 'class="active"' ?><!-->-->
<!--                                                <a href="--><?php //echo TravelHelper::get_user_dashboared_link($user_link, 'my-room'); ?><!--">--><?php //_e("My Room", 'traveler') ?>
<!--                                                    <span class="badge fa fa-angle-down badge-success"></span></a>-->
<!--                                            </li>-->
...
<!--                            --><?php //endif; ?>
<!--                            --><?php //if (STUser_f::_check_service_available_partner('st_tours')): ?>
<!--                                <li class="sidebar-dropdown st-active --><?php //if (in_array($sc, array('my-tours', 'create-tours', 'edit-tours', 'add-tour-booking', 'booking-tours'))) {
//                                    echo 'active';
//                                } ?><!--">-->
<!--                                    <a href="#">-->
<!--                                        <img src="--><?php //echo get_template_directory_uri() . "/v2/images/dashboard/ico_tour.svg"; ?><!--"-->
<!--                                             alt="" class="st-icon-menu">-->
...
//                                                echo 'class="active"' ?><!-->-->
<!--                                                <a href="--><?php //echo TravelHelper::get_user_dashboared_link($user_link, 'my-tours'); ?><!--">--><?php //_e("My Tour", 'traveler') ?>
<!--                                                    <span class="badge fa fa-angle-down badge-success"></span></a>-->
<!--                                            </li>-->
...
<!--                            --><?php //endif; ?>
                            <?php if (STUser_f::_check_service_available_partner('st_activity')): ?>
                                <li class="sidebar-dropdown st-active <?php if (in_array($sc, array('create-activity', 'edit-activity', 'my-activity', 'booking-activity', 'add-activity-booking'))) {
                                    ...
                                    <a href="#">
                                        <img src="<?php echo get_template_directory_uri() . "/v2/images/dashboard/ico_activities.svg"; ?>"
                                             alt="" class="st-icon-menu">
                                    ...
                                    <div class="sidebar-submenu">
                                        <ul>
                                            <li>
                                                <a href="<?php echo TravelHelper::get_user_dashboared_link($user_link, 'my-activity'); ?>"><?php _e("My Activity", 'traveler') ?>
                                                    <span class="badge fa fa-angle-down badge-success"></span></a>
                                            </li>
...
<!--                            <!-- Car -->-->
<!--                            --><?php //if (STUser_f::_check_service_available_partner('st_cars')): ?>
<!--                                <li class="sidebar-dropdown st-active --><?php //if (in_array($sc, array('create-cars', 'edit-cars', 'my-cars', 'booking-cars', 'add-car-booking', 'add-cartransfer-booking'))) {
//                                    echo 'active';
//                                } ?><!--">-->
<!--                                    <a href="#">-->
<!--                                        <img src="--><?php //echo get_template_directory_uri() . "/v2/images/dashboard/ico_car.svg"; ?><!--"-->
<!--                                             alt="" class="st-icon-menu">-->
...
<!--                                            <li --><?php //if ($sc == 'my-car')
//                                                echo 'class="active"' ?><!-->-->
<!--                                                <a href="--><?php //echo TravelHelper::get_user_dashboared_link($user_link, 'my-cars'); ?><!--">--><?php //_e("My Car", 'traveler') ?>
<!--                                                    <span class="badge fa fa-angle-down badge-success"></span></a>-->
<!--                                            </li>-->
...
//                                                echo 'class="active"' ?><!--><a-->
<!--                                                        href="--><?php //echo TravelHelper::get_user_dashboared_link($user_link, 'add-car-booking'); ?><!--">--><?php //_e("Add Booking Car", 'traveler') ?>
<!--                                                </a>-->
<!--                                            </li>-->
<!--                                            <li --><?php //if ($sc == 'add-cartransfer-booking')
//                                                echo 'class="active"' ?><!--><a-->
<!--                                                        href="--><?php //echo TravelHelper::get_user_dashboared_link($user_link, 'add-cartransfer-booking'); ?><!--">--><?php //_e("Add Booking Car Transfer", 'traveler') ?>
<!--                                                </a>-->
<!--                                            </li>-->
<!--                                            <li --><?php //if ($sc == 'booking-cars')
//                                                echo 'class="active"' ?><!--><a-->
<!--                                                        href="--><?php //echo TravelHelper::get_user_dashboared_link($user_link, 'booking-cars'); ?><!--">--><?php //_e("Car Bookings", 'traveler') ?>
<!--                                                </a>-->
<!--                                            </li>-->
<!--                                        </ul>-->
<!--                                    </div>-->
...
//                                                echo 'class="active"' ?><!-->-->
<!--                                                <a href="--><?php //echo TravelHelper::get_user_dashboared_link($user_link, 'my-rental'); ?><!--">--><?php //_e("My Rental", 'traveler') ?>
<!--                                                    <span class="badge fa fa-angle-down badge-success"></span></a>-->
<!--                                            </li>-->
...
//                                } ?><!--">-->
<!--                                    <a href="#">-->
<!--                                        <img src="--><?php //echo get_template_directory_uri() . "/v2/images/dashboard/ico_fly.svg"; ?><!--"-->
<!--                                             alt="" class="st-icon-menu">-->
...
<!--                                        <ul>-->
<!--                                            <li>-->
<!--                                                <a href="--><?php //echo TravelHelper::get_user_dashboared_link($user_link, 'my-flights'); ?><!--">--><?php //_e("My Flight", 'traveler') ?>
<!--                                                    <span class="badge fa fa-angle-down badge-success"></span></a>-->
<!--                                            </li>-->
...
<!--                            --><?php //endif; ?>
                            <?php if (is_super_admin()): ?>
                                <li class="<?php if (in_array($sc, array('list-refund'))) echo "active" ?>">
                                    <a href="<?php echo TravelHelper::get_user_dashboared_link($user_link, 'list-refund'); ?>">
                                        <img src="<?php echo get_template_directory_uri() . "/v2/images/dashboard/ico_refund.svg"; ?>"
                                             alt="" class="st-icon-menu">
                        ...
                        <?php if ($lever != "administrator" && st()->get_option('enable_withdrawal', 'on') == 'on') { ?>
                            ...
                            <li class="sidebar-dropdown st-active <?php if (in_array($sc, array('withdrawal', 'withdrawal-history'))) {
                                ...
                                <a href="<?php echo TravelHelper::get_user_dashboared_link($user_link, 'withdrawal'); ?>">
                                    <img src="<?php echo get_template_directory_uri() . "/v2/images/dashboard/ico_wishlish.svg"; ?>"
                                         alt="" class="st-icon-menu">
                        ...
                        <?php if (st_user_has_partner_features()) { ?>
                            <li class="<?php if (in_array($sc, array('verify_user'))) echo "active" ?>">
                                <a href="<?php echo TravelHelper::get_user_dashboared_link($user_link, 'verify_user'); ?>">
                                    <img src="<?php echo get_template_directory_uri() . "/v2/images/dashboard/ico_verifications.svg"; ?>"
                                         alt="" class="st-icon-menu">
                        ...
                        <li class="<?php if ($sc == 'inbox') echo 'active' ?>">
                            <a href="<?php echo TravelHelper::get_user_dashboared_link($user_link, 'inbox'); ?>">
                                <img src="<?php echo get_template_directory_uri() . "/v2/images/dashboard/ico_inbox.svg"; ?>"
                                     alt="" class="st-icon-menu">
